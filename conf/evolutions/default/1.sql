...
alter table cultura add constraint fk_cultura_persona_3 foreign key (persona_id) references persona (id) on delete restrict on update restrict;
create index ix_cultura_persona_3 on cultura (persona_id);
...
alter table transporte add constraint fk_transporte_persona_8 foreign key (persona_id) references persona (id) on delete restrict on update restrict;
create index ix_transporte_persona_8 on transporte (persona_id);
